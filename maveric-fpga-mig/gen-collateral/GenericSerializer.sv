...
module GenericSerializer(
  ...
  input         io_in_valid,	// @[generators/testchipip/src/main/scala/Serdes.scala:166:14]
  ...
  output        io_out_valid,	// @[generators/testchipip/src/main/scala/Serdes.scala:166:14]
  output [3:0]  io_out_bits	// @[generators/testchipip/src/main/scala/Serdes.scala:166:14]
);
  ...
  reg  [5:0]   sendCount;	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
  wire         wrap_wrap = sendCount == 6'h28;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :73:24]
  ...
  always @(posedge clock) begin
    if (_GEN)	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
      data <= {4'h0, data[163:4]};	// @[generators/testchipip/src/main/scala/Serdes.scala:174:17, :189:37]
    ...
    if (reset) begin
      ...
      sendCount <= 6'h0;	// @[src/main/scala/chisel3/util/Counter.scala:61:40]
    end
    else begin
      sending <= ~(_GEN & wrap_wrap) & (_GEN_0 | sending);	// @[generators/testchipip/src/main/scala/Serdes.scala:176:24, :184:21, :186:13, :191:{19,29}, src/main/scala/chisel3/util/Counter.scala:73:24, :117:24, :118:{16,23}, src/main/scala/chisel3/util/Decoupled.scala:52:35]
      if (_GEN) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:52:35]
        if (wrap_wrap)	// @[src/main/scala/chisel3/util/Counter.scala:73:24]
          ...
          sendCount <= sendCount + 6'h1;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :77:24]
      end
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        sendCount = _RANDOM[3'h5][10:5];	// @[generators/testchipip/src/main/scala/Serdes.scala:174:17, src/main/scala/chisel3/util/Counter.scala:61:40]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits = data[3:0];	// @[generators/testchipip/src/main/scala/Serdes.scala:174:17, :181:22]
endmodule
