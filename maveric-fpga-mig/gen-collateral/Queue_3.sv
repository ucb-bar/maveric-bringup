...
module Queue_3(
  ...
  assign io_deq_bits_id = ram[3:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_addr = ram[35:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_len = ram[43:36];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_size = ram[46:44];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_burst = ram[48:47];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_lock = ram[49];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_cache = ram[53:50];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_prot = ram[56:54];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_qos = ram[60:57];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_echo_tl_state_size = ram[64:61];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_echo_tl_state_source = ram[68:65];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
  assign io_deq_bits_wen = ram[69];	// @[src/main/scala/chisel3/util/Decoupled.scala:274:95]
endmodule
